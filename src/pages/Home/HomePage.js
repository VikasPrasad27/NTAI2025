        ...
        <>
            <div className="container-fluid position-relative p-0">
                ...
                <div className="position-absolute top-50 start-50 translate-middle text-center">
                    {showFirstText ? (
                        <h1 className="fadeInOut misty-text sunShadow">International conference on Nextgen Technology and Ai for a sustainable future (NTAI2025)</h1>
                    ) : (        
                        <img src={homelogo} alt="NTAI2025 logo" className="sunShadow  w-full h-[20vh]" />

                    )}
                    <CountdownTimer date={new Date('2025-04-12T13:00:00')}/>
